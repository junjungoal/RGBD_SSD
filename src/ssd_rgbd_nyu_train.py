...
rgb_gt = pickle.load(open('../pkls/train_nyu_RGB.pkl', 'rb'))
depth_gt = pickle.load(open('../pkls/train_nyu_depth.pkl', 'rb'))

rgb_keys = sorted(rgb_gt.keys())
depth_keys = sorted(depth_gt.keys())

total_keys = len(rgb_keys)
num_train = int(total_keys * 0.8)
