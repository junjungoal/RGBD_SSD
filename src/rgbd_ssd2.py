...
def RGBD_SSD300(input_shape, depth_input_shape, num_classes=21):
 ...
 #                    weights=[weights[0], weights[1]]
    ...
    conv1_3 = concatenate([conv1_2, depth_conv1_2], axis=3)
    ...
    conv2_3 = concatenate([conv2_2, depth_conv2_2], axis=3)
    ...
    conv3_4 = concatenate([conv3_3, depth_conv3_3], axis=3)
    ...
    conv4_4 = concatenate([conv4_3, depth_conv4_3], axis=3)
