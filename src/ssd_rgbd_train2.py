...
import pickle
import keras
from rgbd_ssd2 import RGBD_SSD300
...
log_path = "../tensor_log/RGBD2/v{:d}".format(args.ver)
    ...
    while True:
        ...
        if iter_num == epoch_length:
            ...
            if curr_val_loss < best_val_loss:
                ...
                model.save_weights('/raid/jun/checkpoints/bmvc/RGBD2/v{:d}/weights.best.hdf5'.format(args.ver))
            iter_num = 0
            break
